# LABEL MAPPINGS
# Mapping of modes of travel labels [i94mode]
travel = {
    1: 'Air',
    2: 'Sea',
    3: 'Land',
...
# Mapping of visa codes labels [i94visa]
visa = {
    1: 'Business',
    2: 'Pleasure',
    3: 'Student'
...
# Mapping of country name labels [i94res]
country = {
...
# Mapping of port name labels [i94port]
port = {
    'ALC': 'ALCAN, AK',
    'ANC': 'ANCHORAGE, AK',
